...
import (
	...
	"github.com/floryn08/homelab-alm/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cde085fa.alm.homelab",
	...
	if err = (&controller.IngressRequestReconciler{
	...
	if err = (&controller.VaultSecretRequestReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "VaultSecretRequest")
		os.Exit(1)
	}
